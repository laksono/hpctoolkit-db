...
!  real, dimension(liw) :: iwmap   ! polation routine
  ! NOTE -- the Lahey debug compiler picks up that this array should be an integer.
  ! HOWEVER -- this error has existed since Flash2 and Paramesh2.
  !  Let's fix it if possible

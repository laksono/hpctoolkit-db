...
!! wrapper
!! to the Eos interface. The Eos interface uses a single, flexible data
...
!! in Eos.h, then you must use the direct interface Eos().  Note that entropy
!! EOS_ENTR is considered a derived variable
!!
!! This version works in EOS_YE mode.  Here, abar and zbar are calculated from
!! the Ye mass scalar, rather than from multiple species.
!!
!!
!!  ARGUMENTS 
!!

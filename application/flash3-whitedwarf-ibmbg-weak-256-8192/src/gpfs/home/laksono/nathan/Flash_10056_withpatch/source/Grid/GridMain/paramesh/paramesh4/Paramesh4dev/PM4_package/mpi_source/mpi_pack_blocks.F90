...
!!$     &                     + offset
        loc_message_size(:) = invar*message_size_cc(:) & 
     &                     +ngcell_on_fc(1)*message_size_fcx(:) & 
     &                     +ngcell_on_fc(2)*message_size_fcy(:) & 
     &                     +ngcell_on_fc(3)*message_size_fcz(:) & 
     &                     +ivaredge*message_size_ec(:) & 
     &                     +ivarcorn*message_size_nc(:) + 3 & 
     &                     + offset
      else
     ...
     &,' ibndvarY ',ibndvarY,' message_size_fcx ',message_size_fcy(itype) & 
     &,' ibndvarZ ',ibndvarZ,' message_size_fcx ',message_size_fcz(itype) & 

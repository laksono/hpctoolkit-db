...
contains
  ...
  subroutine nameValueLL_addReal (context, name, value)
  ...
  subroutine nameValueLL_addInt (context, name, value)
  ...
  subroutine nameValueLL_addStr (context, name, value)
  ...
  subroutine nameValueLL_addLog (context, name, value)

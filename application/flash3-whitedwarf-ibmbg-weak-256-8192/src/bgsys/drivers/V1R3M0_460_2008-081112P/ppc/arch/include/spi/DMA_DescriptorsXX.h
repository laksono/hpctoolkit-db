...
class DMA_Descriptor
{
 public:
  ...
  inline void setDoneCallback ( void (*cb_done)(void *, void *),
			        void * clientdata )
  {
    _cb_done    = cb_done;
...
class DMA_MemoryFifoDescriptor : public DMA_Descriptor
{
 public:
  ...
  inline void clone (DMA_MemoryFifoDescriptor & obj)
  {
    ...
    _bgp_QuadLoad ( this, 0 );
    _bgp_QuadLoad ( ((char*)this)+16, 1);

    // Move last 8 bytes
    *(((unsigned*)&obj)+8) = *(((unsigned*)this)+8);
    *(((unsigned*)&obj)+9) = *(((unsigned*)this)+9);
     
    _bgp_QuadStore ( &obj, 0);
    _bgp_QuadStore ( ((char*)&obj)+16, 1);
  }

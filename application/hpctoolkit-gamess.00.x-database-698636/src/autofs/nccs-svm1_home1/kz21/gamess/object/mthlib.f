...
C 22 Sep 15 - HL  - SKIP CHECKING INTER-NUC DISTANCE FOR QUANPOL        
C 22 Oct 14 - DGF - ADD symortho                                        
C 19 Oct 12 - MWS - synchronize FRGINF common                           
C 16 APR 12 - LBR = DTRTRI,DTRTI2,DPOTRF,DPOTF2,DISNANX,DLAISNANX,      
C                   DGELS: REMOVED                                      
C 28 DEC 11 - DGF - ADD TFTRI0                                          
C 11 AUG 11 - PEA - SYNCHRONIZE NUCPOS COMMON                           
C  1 OCT 10 - MK  - UNDO INADVERTENT JUNE 2010 CHANGE OF      TO CBL3   
...
C                                                                       
      ANORM = 0.0D+00                                                   
      DO 10 J = 1, N                                                    
         ANORM = MAX(ANORM,XASUM(N,A(1,J),1))                           
   10 CONTINUE                                                          
...
C                                                                       
      DO 120 KB = 1, N                                                  
         K = N + 1 - KB                                                 
         IF (K .LT. N) Z(K) = Z(K) + XDOT(N-K,A(K+1,K),1,Z(K+1),1)      
...
C                                                                       
      DO 140 K = 1, N                                                   
         ...
         Z(L) = Z(K)                                                    
         Z(K) = T                                                       
         IF (K .LT. N) CALL XAXPY(N-K,T,A(K+1,K),1,Z(K+1),1)            
...
C                                                                       
  ...
  150    CONTINUE                                                       
         ...
         T = -Z(K)                                                      
         CALL XAXPY(K-1,T,A(1,K),1,Z(1),1)                              
  160 CONTINUE                                                          
C     MAKE ZNORM = 1.0                                                  
      S = 1.0D+00/XASUM(N,Z,1)                                          
      CALL XSCAL(N,S,Z,1)                                               
...
C                                                                       
      IF (MOD(JOB,10) .EQ. 0) GO TO 150                                 
         DO 100 K = 1, N                                                
            A(K,K) = 1.0D+00/A(K,K)                                     
            T = -A(K,K)                                                 
            CALL XSCAL(K-1,T,A(1,K),1)                                  
            KP1 = K + 1                                                 
            IF (N .LT. KP1) GO TO 90                                    
            DO 80 J = KP1, N                                            
               T = A(K,J)                                               
               A(K,J) = 0.0D+00                                         
               CALL XAXPY(K,T,A(1,K),1,A(1,J),1)                        
   80       CONTINUE                                                    
   90       CONTINUE                                                    
  100    CONTINUE                                                       
C                                                                       
...
C                                                                       
  ...
  110       CONTINUE                                                    
            DO 120 J = KP1, N                                           
               T = WORK(J)                                              
               CALL XAXPY(N,T,A(1,J),1,A(1,K),1)                        
  120       CONTINUE                                                    
            L = IPVT(K)                                                 
            IF (L .NE. K) CALL XSWAP(N,A(1,K),1,A(1,L),1)               
  130    CONTINUE                                                       
  140    CONTINUE                                                       
  150 CONTINUE                                                          
      RETURN                                                            
...
C                                                                       
            DO 30 J = KP1, N                                            
               ...
               IF (L .EQ. K) GO TO 20                                   
                  ...
                  A(K,J) = T                                            
   20          CONTINUE                                                 
               CALL XAXPY(N-K,T,A(K+1,K),1,A(K+1,J),1)                  
   30       CONTINUE                                                    
         GO TO 50                                                       
   40    CONTINUE                                                       
            INFO = K                                                    
...
C                                                                       
         ...
         DO 20 K = 1, NM1                                               
            ...
            IF (L .EQ. K) GO TO 10                                      
               ...
               B(K) = T                                                 
   10       CONTINUE                                                    
            CALL XAXPY(N-K,T,A(K+1,K),1,B(K+1),1)                       
   20    CONTINUE                                                       
   30    CONTINUE                                                       
C                                                                       
C        NOW SOLVE  U*X = Y                                             
C                                                                       
         DO 40 KB = 1, N                                                
            ...
            B(K) = B(K)/A(K,K)                                          
            T = -B(K)                                                   
            CALL XAXPY(K-1,T,A(1,K),1,B(1),1)                           
   40    CONTINUE                                                       
      GO TO 100                                                         
   50 CONTINUE                                                          
C                                                                       
...
C                                                                       
         ...
         DO 80 KB = 1, NM1                                              
            K = N - KB                                                  
            B(K) = B(K) + XDOT(N-K,A(K+1,K),1,B(K+1),1)                 
            L = IPVT(K)                                                 
            IF (L .EQ. K) GO TO 70                                      
               T = B(L)                                                 
               B(L) = B(K)                                              
...
C                                                                       
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)                                
C                                                                       
      PARAMETER (NATBIG=100)                                            
      PARAMETER (UNIT=0.52917724924D+00)                                
      PARAMETER (CLOSE=0.1D+00)                                         
      PARAMETER (RMARK=3.0D+00)                                         
...
C                                                                       
         IF(NFG.EQ.0  .AND.  .NOT.POSNEO .AND.NFFAT.EQ.0) THEN          
...
C                                                                       
      CALL XGEMM('N','N',NA,MB,MA,ONE,A,LDA,B,LDB,ZERO,C,LDC)           
      IF(ONE.NE.ZERO) RETURN                                            
C                                                                       
      M=MA                                                              
      IF(MOD(M,2).NE.0) M=M-1                                           
C                                                                       
CCC can parallelize this loop - but check timings                       
      DO 300 I=1,NA                                                     
         DO 200 J=1,MB                                                  
            CIJ=ZERO                                                    
...
C               AND EFFECTIVE COLUMN DIMENSION OF MATRIX B              
C        LDB  - THE LEADING DIMENSION OF MATRIX B                       
C        NN   - THE COLUMN DIMENSION OF MATRIX C,                       
C               AND EFFECTIVE ROW DIMENSION OF MATRIX B.                
C        LDC  - THE LEADING DIMENSION OF MATRIX C                       
...
C                                                                       
      CALL XGEMM('N','T',LL,NN,MM,ONE,A,LDA,B,LDB,ZERO,C,LDC)           
      IF(ONE.NE.ZERO) RETURN                                            
C                                                                       
      KMAX=MM                                                           
...
C                                                                       
      CALL XGEMM('T','N',MA,MB,NA,ONE,A,LDA,B,LDB,ZERO,C,LDC)           
      IF(ONE.NE.ZERO) RETURN                                            
C                                                                       
      DO 110 J=1,MB                                                     
         DO 100 I=1,MA                                                  
      ...
      DO 150 I=2,NA                                                     
         ...
         DO 140 J=1,IM1                                                 
            ...
            IF(AIJ.EQ.ZERO) GO TO 140                                   
               CALL XAXPY(MB,AIJ,B(I,1),NA,AB(J,1),NAB)                 
               CALL XAXPY(MB,AIJ,B(J,1),NA,AB(I,1),NAB)                 
  140    CONTINUE                                                       
  150 CONTINUE                                                          
      RETURN                                                            
      END                                                               
...
C                                                                       
      DO 100 J=1,N                                                      
         ...
         END IF                                                         
C            C = B*C                                                    
         CALL XSPMV(UPLO,K,ONE,B,C(1,J),1,ZERO,WRK,1)                   
         CALL XCOPY(K,WRK,1,C(1,J),1)                                   
C            C = OP(A)*C                                                
         CALL XGEMV(TRANSA,MM,KK,ONE,A,LDA,C(1,J),1,ZERO,WRK,1)         
         CALL XCOPY(M,WRK,1,C(1,J),1)                                   
 100  ENDDO                                                             
C                                                                       
...
C*                                                                      
      ...
      IF(NCOLS.EQ.1) GO TO 130                                          
         NCOLM1=NCOLS-1                                                 
         DO 120 I=1,NCOLM1                                              
            VLENSQ=XDOT(NROWS,VECT(1,I),1,VECT(1,I),1)                  
...
C                                                                       
  100       CONTINUE                                                    
            ...
            CALL XSCAL(NROWS,VNORM,VECT(1,I),1)                         
            IPLUS1 = I + 1                                              
            DO 110 J=IPLUS1,NCOLS                                       
               VOVLP=XDOT(NROWS,VECT(1,I),1,VECT(1,J),1)                
               CALL XAXPY(NROWS,-VOVLP,VECT(1,I),1,VECT(1,J),1)         
  110       CONTINUE                                                    
  120    CONTINUE                                                       
  130 CONTINUE                                                          
C                                                                       
C        DO LAST VECTOR                                                 
C                                                                       
      VLENSQ=XDOT(NROWS,VECT(1,NCOLS),1,VECT(1,NCOLS),1)                
...
C                                                                       
  140 CONTINUE                                                          
      VNORM=ONE/SQRT(VLENSQ)                                            
      CALL XSCAL(NROWS,VNORM,VECT(1,NCOLS),1)                           
      RETURN                                                            
      END                                                               
C                                                                       
...
C                                                                       
  ...
  220       CONTINUE                                                    
               ...
               IN = IN - NA                                             
               IH = IH - NA                                             
               CALL XCOPY(NA,C(IH+1),1,C(IN+1),1)                       
...
C*MODULE MTHLIB  *DECK PRATM                                            
      ...
      USE MX_LIMITS,ONLY:MXPT,MXFRG,MXFGPT,MXDFG,MXDPPT,mxsh,mxatm,mxao 
      USE comm_FRGMSS                                                   
      USE comm_EFMULT                                                   
      USE comm_FRGINF                                                   
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)                                
...
C*MODULE MTHLIB  *DECK PRCIVC                                           
     ...
     *                  LEVIR,ICASE,IECONF,IARC,NOMX,NR4,NROWS)         
      use mx_limits, only: mxao,mxatm,mxsh                              
C                                                                       
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)                                
C                                                                       
...
C>                                                                      
C>    @brief    print eigenvector/values                                
C>                                                                      
C>    @details  This routine also prints AO labels down the side.       
C>              See PRSQ to print rectangular matrices w/o tags.        
C>              See PREVNL and PREVS for similar functionality.         
C>                                                                      
C>    @author   original to GAMESS                                      
C>                                                                      
...
C                                                                       
      LOGICAL GOPARR,DSKWRK,MASWRK                                      
      LOGICAL AIMPAC,RPAC,PLTORB,MOLPLT,DGRIDPROG                       
C                                                                       
C                                                                       
...
C                                                                       
  100 IMIN = IMAX+1                                                     
      ...
      IF (IMAX .GT. M) IMAX = M                                         
      WRITE (IW,9008)                                                   
      IF(.NOT.DGRIDPROG) THEN                                           
         WRITE (IW,9028) (I,I = IMIN,IMAX)                              
         WRITE (IW,9008)                                                
         WRITE (IW,9038) (E(I),I = IMIN,IMAX)                           
         WRITE (IW,9008)                                                
      ELSE                                                              
         WRITE (IW,9128) (I,I = IMIN,IMAX)                              
         WRITE (IW,9008)                                                
         WRITE (IW,9138) (E(I),I = IMIN,IMAX)                           
         WRITE (IW,9008)                                                
      ENDIF                                                             
      DO J = 1,N                                                        
         IF(.NOT.DGRIDPROG) THEN                                        
         ...
         ELSE                                                           
            WRITE (IW,9148) J,BFLAB(J),(V(J,I),I = IMIN,IMAX)           
         ENDIF                                                          
      ENDDO                                                             
...
C                                                                       
 ...
 9038 FORMAT(15X,10F11.4)                                               
 9048 FORMAT(I5,2X,A8,10F11.6)                                          
C          same formats except wider                                    
 9128 FORMAT(15X,10(8X,I4,5X))                                          
 9138 FORMAT(15X,10F17.10)                                              
 9148 FORMAT(I5,10X,10F17.10)                                           
      END                                                               
C                                                                       
C*MODULE MTHLIB  *DECK PREVNL                                           
C>                                                                      
C>    @brief    print eigenvector/values, only                          
C>                                                                      
C>    @details  There are no MO symmetry labels across the top,         
C>              and no AO labels down the side.  Pure eigendata.        
C>              See PRSQ to print rectangular matrices w/o eigenvals.   
C>                                                                      
C>    @author   Mike Schmidt, perhaps.                                  
C>                                                                      
...
C>                                                                      
C>    @brief    print eigenvector/values, with MO symmetry labels       
C>                                                                      
C>    @details  This routine also prints AO labels down the side.       
C>              See PREV and PREVNL for similar functionality.          
C>              See PRSQ to print rectangular matrices w/o tags.        
C>                                                                      
C>    @author   Mike Schmidt, by cloning from PREV at the time          
C>              GAMESS learned how to generate orbital symmetry tags    
C>                                                                      
...
C                                                                       
  100 IMIN = IMAX+1                                                     
      ...
      ELSE                                                              
         WRITE (IW,9128) (I,       I=IMIN,IMAX)                         
         WRITE (IW,9168) (E(I),    I=IMIN,IMAX)                         
         WRITE (IW,9178) (LABMO(I),I=IMIN,IMAX)                         
      ENDIF                                                             
      DO J = 1,NAO                                                      
         IF(.NOT.DGRIDPROG) THEN                                        
            WRITE (IW,9048) J,BFLAB(J),(V(J,I),I = IMIN,IMAX)           
...
C          same formats except wider                                    
 9128 FORMAT(15X,10(8X,I4,5X))                                          
 9148 FORMAT(I5,2X,A8,10F17.10)                                         
 9168 FORMAT(15X,10F17.10)                                              
 9178 FORMAT(16X,10(8X,A4,5X))                                          
      END                                                               
C*MODULE MTHLIB  *DECK PREVSS                                           
C>                                                                      
C>    @brief    print eigenvector/values, with MO symmetry labels       
C>                                                                      
C>    @details  This routine also prints AO labels down the side.       
C>              See PREVS for similar functionality.                    
C>                                                                      
C>    @author   Dmitri Fedorov, by cloning from PREVS at the time       
C>                                                                      
      SUBROUTINE PREVSS(V,E,LABMO,BFLAB,NMO,NAO,LDV,ISTMO)              
C                                                                       
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)                                
C                                                                       
      LOGICAL GOPARR,DSKWRK,MASWRK                                      
      LOGICAL AIMPAC,RPAC,PLTORB,MOLPLT,DGRIDPROG                       
C                                                                       
      DIMENSION V(LDV,NMO),E(NMO),LABMO(NMO),BFLAB(NAO)                 
C                                                                       
      COMMON /IOFILE/ IR,IW,IP,IJK,IJKT,IDAF,NAV,IODA(950)              
      COMMON /OUTPUT/ NPRINT,ITOL,ICUT,NORMF,NORMP,NOPK                 
      COMMON /PAR   / ME,MASTER,NPROC,IBTYP,IPTIM,GOPARR,DSKWRK,MASWRK  
...
C                                                                       
      IF (MASWRK) THEN                                                  
c     IF(NFG.NE.0) CALL FMOESCA(0,E,NMO)                                
      MAX = 5                                                           
      IF (NPRINT .EQ. 6) MAX = 10                                       
      IMAX = ISTMO-1                                                    
C                                                                       
  100 IMIN = IMAX+1                                                     
      ...
      ENDDO                                                             
      IF (IMAX .LT. NMO) GO TO 100                                      
c     IF(NFG.NE.0) CALL FMOESCA(1,E,NMO)                                
      END IF                                                            
      RETURN                                                            
C                                                                       
 9008 FORMAT(1X)                                                        
...
C          same formats except wider                                    
 ...
 9178 FORMAT(16X,10(8X,A4,5X))                                          
      END                                                               
C                                                                       
C*MODULE MTHLIB  *DECK PREVSQMC                                         
C> @brief   PUNCH EIGENDATA                                             
C>                                                                      
C> @details A CLONE OF PREVS, MODIFIED FOR QMC                          
C>                                                                      
C> @author  D. G. Fedorov                                               
C>                                                                      
C> @param   NFTQMC Record number used in QMC                            
C> @param   V      MO coefficients                                      
C> @param   E      Eigenvalues                                          
C> @param   LAMBO  Symmetry label                                       
C> @param   NMO    Number of molecular orbitals                         
C> @param   NAO    Number of atomic    orbitals                         
C> @param   LDV    Leading dimension of V                               
C> @param   ISTMO  Beginning of orbital                                 
C>                                                                      
      SUBROUTINE PREVSQMC(NFTQMC,V,E,LABMO,NMO,NAO,LDV,ISTMO)           
      use mx_limits, only: mxatm,mxao                                   
C                                                                       
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)                                
C                                                                       
...
C                                                                       
  100 IMIN = IMAX+1                                                     
      ...
      IF (IMAX .GT. NMO) IMAX = NMO                                     
      WRITE (NFTQMC,9008)                                               
      WRITE (NFTQMC,9028) (I,       I=IMIN,IMAX)                        
      WRITE (NFTQMC,9068) (E(I),    I=IMIN,IMAX)                        
      WRITE (NFTQMC,9078) (LABMO(I),I=IMIN,IMAX)                        
      DO 120 J = 1,NAO                                                  
         WRITE (NFTQMC,9048) J,BFLAB(J),(V(J,I),I = IMIN,IMAX)          
  120 CONTINUE                                                          
      IF (IMAX .LT. NMO) GO TO 100                                      
      IF(NFG.NE.0) CALL FMOESCA(1,E,NMO)                                
      END IF                                                            
      RETURN                                                            
C                                                                       
 9000 FORMAT(1X,'QMC TOTAL NUMBER OF MOS IN VARIATION SPACE     =',I10) 
 9008 FORMAT(1X,'QMC')                                                  
 9028 FORMAT(1X,'QMC',15X,10(5X,I5,5X))                                 
 9048 FORMAT(1X,'QMC',I5,2X,A8,10F15.10)                                
 9068 FORMAT(1X,'QMC',15X,10F15.8)                                      
 9078 FORMAT(1X,'QMC',16X,10(7X,A4,4X))                                 
      END                                                               
C                                                                       
...
C                                                                       
      LUFILE = IP                                                       
      CALL PUSQLF(LUFILE,V,M,N,LDV,0)                                   
      RETURN                                                            
      END                                                               
C                                                                       
C*MODULE MTHLIB  *DECK PUSQLF                                           
C> @brief      PUNCH A RECTANGULAR MATRIX WITH ORDERING LABELS          
C>                                                                      
C> @author     Unknown                                                  
C>             -Unknown                                                 
C>                                                                      
C> @param      ISHFT allows one to shift the orbital number.            
C>                                                                      
      SUBROUTINE PUSQLF(LUFILE,V,M,N,LDV,ISHFT)                         
C                                                                       
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)                                
C                                                                       
      LOGICAL GOPARR,DSKWRK,MASWRK                                      
...
C                                                                       
      ...
      DO 180 I = 1,L1                                                   
         IF (EIG(I) .LT. TOL) GO TO 160                                 
            ...
            IF(I.GT.J) CALL XCOPY(L1,Q(1,I),1,Q(1,J),1)                 
            GO TO 180                                                   
  160    K = K+1                                                        
  180 CONTINUE                                                          
C                                                                       
...
C                                                                       
      IF (M.GT.0) THEN                                                  
         DO I=1,M-1                                                     
            DUMI = ONE/XNRM2(N,V(1,I),1)                                
            CALL XSCAL(N,DUMI,V(1,I),1)                                 
            CALL XGEMV('T',N,M-I,ONE,V(1,I+1),LDV,V(1,I),1,ZERO,X,1)    
            CALL XGER(N,M-I,-ONE,V(1,I),1,X,1,V(1,I+1),LDV)             
         ENDDO                                                          
         DUMI = ONE/XNRM2(N,V(1,M),1)                                   
         CALL XSCAL(N,DUMI,V(1,M),1)                                    
      ENDIF                                                             
C                                                                       
...
C                                                                       
      DO ITER=1,NITER                                                   
C                P = Q-DAGGER * R                                       
         CALL XGEMV('T',M,NN,ONE,Q(1,J1),LDQ,R,1,ZERO,P,1)              
C                R = -Q * P + R                                         
         CALL XGEMV('N',M,NN,-ONE,Q(1,J1),LDQ,P,1,BETA,R,1)             
...
C                                                                       
      ...
      DO I=1,M                                                          
         ...
         DO J=1,I-1                                                     
            CALL XAXPY(N,-XDOT(N,WRK,1,V(1,J),1),V(1,J),1,V(1,I),1)     
         ENDDO                                                          
         Q=SQRT(XDOT(N,WRK,1,V(1,I),1))                                 
         IF(ABS(Q).LT.SMALL) THEN                                       
            IF(MASWRK) WRITE(IW,9000) I                                 
            NSMALL=NSMALL+1                                             
         ELSE                                                           
            CALL XSCAL(N,1.0D+00/Q,V(1,I),1)                            
         END IF                                                         
      ENDDO                                                             
...
C                                                                       
      ...
      DO 120 I = 1,NCOORD                                               
         X(I20-1+I) = XDOT(NVAR,DS,1,X(I10-1+I),NQ1)                    
  120 CONTINUE                                                          
C                                                                       
C     ----- MOVE THE TRANSFORMED DISPLACEMENT BACK TO DS -----          
C                                                                       
      CALL XCOPY(NCOORD,X(I20),1,DS,1)                                  
C                                                                       
...
C                                                                       
      DO 100 J=1,M                                                      
         IF(PARALL3) THEN                                               
            ...
            END IF                                                      
         END IF                                                         
         CALL XGEMV('N',N,M,ONE,Q,LDQV,V(1,J),1,ZERO,WRK,1)             
         DO I=1,N                                                       
            IF (ABS(WRK(I)).LT.SMALL) WRK(I) = ZERO                     
         ENDDO                                                          
         CALL XCOPY(N,WRK,1,V(1,J),1)                                   
  100 CONTINUE                                                          
C                                                                       
...
C-ORIG-            DO 100 I = 1,N                                       
C-ORIG-               W = XDOT(M,Q(I,1),LDQV,V(1,JJ),1)                 
...
C                                                                       
         DO 300 II=I,IIMAX                                              
            DO 100 L=1,N                                                
               WRK(L) = XDOT(N,T(1,II),1,F(1,L),1)                      
  100       CONTINUE                                                    
            DO 200 J=1,M                                                
               H(II,J) = XDOT(N,WRK,1,T(1,J),1)                         
  200       CONTINUE                                                    
  300    CONTINUE                                                       
  310 CONTINUE                                                          
C                                                                       
...
C                                                                       
      DO 100 J = 1,M                                                    
         ...
         END IF                                                         
         IJ = (J*J-J)/2                                                 
         CALL XSPMV('U',N,ONE,F,T(1,J),1,ZERO,WRK,1)                    
         CALL XGEMV('T',N,J,ONE,T,LDT,WRK,1,ZERO,H(IJ+1),1)             
         DO I=1,J                                                       
...
C-ORIG-               IJ = IJ+1                                         
C-ORIG-               HIJ = XDOT(N,T(1,I),1,WRK,1)                      
...
C-ORIG-      RETURN                                                     
      END                                                               
C                                                                       
C*MODULE MTHLIB  *DECK TFTRI0                                           
      SUBROUTINE TFTRI0(H,F,T,WRK,M,N,LDT)                              
C                                                                       
      use omp_lib                                                       
C                                                                       
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)                                
...
C                                                                       
      ...
      DO 100 I = 1,NVAR                                                 
         IADD = IADD + NQ1                                              
         X(I20-1+I) = XDOT(NCOORD,G,1,X(IADD),1)                        
  100 CONTINUE                                                          
C                                                                       
C     ----- MOVE THE TRANSFORMED GRADIENT BACK INTO G -----             
C                                                                       
      CALL XCOPY(NVAR,X(I20),1,G,1)                                     
...
C                                                                       
      ...
      DO 100 I = 1,NCOORD                                               
         IADD = IADD + NQ1                                              
         X(I20-1+I) = XDOT(NVAR,G,1,X(IADD),1)                          
  100 CONTINUE                                                          
C                                                                       
C     ----- MOVE THE TRANSFORMED GRADIENT BACK INTO G -----             
C                                                                       
      CALL XCOPY(NCOORD,X(I20),1,G,1)                                   
...
C                                                                       
  ...
  110    CONTINUE                                                       
  120 CONTINUE                                                          
      IF(KIND.NE.0) CALL XCOPY(M*N,B,1,A,1)                             
      RETURN                                                            
      END                                                               
C                                                                       
...
C                                                                       
!$omp parallel do schedule(dynamic) private(j,jmo,i,tmp)                
      DO 100 J = 2,N                                                    
         JMO = J - 1                                                    
         DO 100 I = 1,JMO                                               
            TMP = A(I,J)                                                
...
C        I = J = K = 1                                                  
C                                                                       
!$omp parallel do private(L) schedule(dynamic)                          
      DO 110 L=1,N                                                      
         C(L) = B(L) - A(L)                                             
  110 CONTINUE                                                          
!$omp end parallel do                                                   
...
C    *            (ANGLES(4),COSB)                                      
      PARAMETER (ZERO=0.0D+00)                                          
      PARAMETER (ONE=1.0D+00)                                           
      PARAMETER (PI=3.14159265358979312D+00)                            
        ...
        IF(IGROW.EQ.LAM) THEN                                           
          ...
          DO 930 IL=1,LAM                                               
            DO 920 IL1=1,LAM                                            
              ...
              ALPHA=XDOT(NUM,PROJ(1,IL,IL1),1,WORK1,1)                  
C                                                                       
...
C                                                                       
              IF(ABS(ALPHA).GT.0.9D-01.AND.JOLT(IL1).EQ.0) THEN         
                DO 910 MM=1,LAM                                         
                  ...
                  CALL MTARBR(S,NUM,PROJ(1,IL,IL1),1,WORK1,NUM,1)       
                  ALPHA1=XDOT(NUM,FUNSYM(1,MM),1,WORK1,1)               
...
C               IDENTICAL PROJECTORS FOR DIFFERENT ROWS (???)           
                CALL XCOPY(NUM,PROJ(1,IL,IL1),1,FUNSYM(1,IL1),1)        
                CALL XSCAL(NUM,ONE/SQRT(ALPHA),FUNSYM(1,IL1),1)         
...
C                                                                       
          DO 960 ILL=1,LAM                                              
            ...
            DO 935 IL=1,LAM                                             
              ...
              ALP(IL)=XDOT(NUM,FUNSYM(1,IL),1,WORK1,1)                  
...
C           IF(ABS(AA-ONE).GT.TOL.AND.MASWRK) WRITE(IW,9100) AA         
            IF(PUREE) THEN                                              
               CALL XCOPY(NUM,FUNSYM(1,ILL),1,CLCAO(1,IMO+NCORE),1)     
            ELSE                                                        
            DO 950 IT=1,NT                                              
              DO 940 IL=1,LAM                                           
                SUM=ZERO                                                
...
C                                                                       
      IF(NPHI.LT.0) CALL XSCAL(NPRI,-ONE,CGC,1)                         
...
C                                                                       
C     GENERATE A 3X3 UNITARY MATRIX THAT ROTATES VECTOR V2 TO V1.       
...
C                                                                       
      ...
      END                                                               
C                                                                       
C*MODULE MTHLIB  *DECK IREORDR                                          
C> @brief      Integer clone of REORDR routine.                         
C>                                                                      
C> @author     Aaron West                                               
C>             -March 26, 2013                                          
C>                                                                      
C> @details    Integer clone of REORDR routine.                         
C>             Reorders 1 or more integer column vectors.               
C>                                                                      
C> @param IV       is the input integer array                           
C>                 with LDVxNCOL dimension.                             
C> @param IORDER   is the integer array with the reorder                
C>                 instructions of NCOLx1 dimension.                    
C> @param NCOL     is the number of columns of array IV.                
C> @param LDV      is the number of rows of array IV.                   
      SUBROUTINE IREORDR(IV,IORDER,NCOL,LDV)                            
C                                                                       
      IMPLICIT NONE                                                     
C                                                                       
      INTEGER LDV,NCOL                                                  
      INTEGER IV(LDV,NCOL),IORDER(NCOL)                                 
      INTEGER I,IP1,J,K                                                 
C                                                                       
...
C                                                                       
      DO 240 I = 1,NCOL                                                 
         J = IORDER(I)                                                  
         CALL ISWAP(LDV,IV(1,I),1,IV(1,J),1)                            
         IP1 = I+1                                                      
         DO 220 K = IP1,NCOL                                            
...
C                                                                       
 9000 FORMAT(1X,'**** ERROR, ORBITAL',I4,' IS MISSING FROM',            
     *          ' REORDERING INSTRUCTIONS IN INTEGER CLONE IREORDR')    
 9010 FORMAT(1X,25I4)                                                   
      END                                                               
C                                                                       
C                                                                       
C*MODULE MTHLIB  *DECK symortho                                         
C> @brief      Symmetric (aka Lowdin) MO orthogonalization.             
C>                                                                      
C> @author     Dmitri Fedorov                                           
C>                                                                      
C> @details    Makes orthogonal orbitals.                               
C>                                                                      
C*MODULE MTHLIB  *DECK symortho                                         
      SUBROUTINE symortho(S,V,SMO,SV,SE,SCR,IWRK,M1,L1,NDIMV,NDIMSV)    
C                                                                       
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)                                
      LOGICAL GOPARR,DSKWRK,MASWRK                                      
      PARAMETER (ONE=1.0D+00)                                           
C                                                                       
      DIMENSION SMO(M1,M1),SE(M1),SV(NDIMSV,M1),IWRK(M1),S((l1*l1+l1)/2)
     *         ,V(NDIMV,M1),SCR(L1*8)                                   
      COMMON /IOFILE/ IR,IW,IP,IJK,IJKT,IDAF,NAV,IODA(950)              
      COMMON /PAR   / ME,MASTER,NPROC,IBTYP,IPTIM,GOPARR,DSKWRK,MASWRK  
C                                                                       
C     ----- ORTHOGONALIZE ORBITALS symmetrically (Lowdin) -----         
c     (symmetric refers to orbital permutation, not point group).       
C     AO OVERLAP -S- MUST BE GIVEN ON ENTRY, AND WILL BE LOST.          
c     M1 - number of MOs                                                
c     L1 - number of AOs, M1<=L1                                        
c     Argument: orbitals in V (unchanged).                              
c     Orthogonalised orbitals will be in SV.                            
c     SMO,SE,SCR,IWRK are scratch. SMO is also used as m2 scratch.      
C                                                                       
C     calculate MO overlaps Sij=CT*S*C                                  
C                                                                       
      CALL TFTRI(SMO,S,V,SCR,M1,L1,NDIMV)                               
c     call prtri(smo,m1)                                                
c                                                                       
c     find eigenvectors/eigenvalues of Sij.                             
c                                                                       
      TOL=1.0D-06                                                       
      IGERR = 0                                                         
      CALL GLDIAG(NDIMSV,M1,M1,SMO,SCR,SE,SV,IGERR,IWRK)                
      IF (IGERR .NE. 0) CALL ABRT                                       
C                                                                       
C     ----- ELIMINATE EIGENVECTORS WITH SMALL EIGENVALUES -----         
C                                                                       
      ...
      K = 0                                                             
      DO 180 I = 1,M1                                                   
         IF (SE(I) .LT. TOL) GO TO 160                                  
            J = J+1                                                     
            SE(J) = ONE/SQRT(SE(I))                                     
            IF(I.GT.J) CALL XCOPY(L1,SV(1,I),1,SV(1,J),1)               
            GO TO 180                                                   
  160    K = K+1                                                        
  180 CONTINUE                                                          
C                                                                       
...
C                                                                       
      IF(K.NE.0) THEN                                                   
         IF(MASWRK) WRITE(IW,9010) DUM,K,TOL,M0                         
c        call vclr(se(m0+1),1,k)                                        
      END IF                                                            
c                                                                       
C     ----- FORM S'=SV * S^(-1/2) * SV^T                                
c                                                                       
      do i=1,m1                                                         
        do j=1,m1                                                       
          sum=0                                                         
c         do k=1,m1                                                     
      ...
      enddo                                                             
c                                                                       
c     call prsq(smo,m1,m1,m1)                                           
c                                                                       
c     Form orthogonal MOs.                                              
c     V=V*S'                                                            
C                                                                       
      call MRARBR(V,NDIMV,L1,M1,SMO,M1,M1,SV,NDIMSV)                    
c                                                                       
c     check the orthogonality.                                          
c                                                                       
c     CALL TFTRI(SMO,S,SV,SCR,M1,L1,NDIMSV)                             
c     call prtri(smo,m1)                                                
      RETURN                                                            
C                                                                       
 9010 FORMAT(20H ..... WARNING ...../                                   
     +     50H THE SMALLEST EIGENVALUE OF THE OVERLAP MATRIX IS ,F15.8/ 
     +     15H THERE IS(ARE) ,I5,25H EIGENVALUE(S) LESS THAN ,1P,E10.2/ 
     +     36H THE NUMBER OF EIGENVECTORS KEPT IS ,I5)                  
      END                                                               
C*MODULE MTHLIB  *DECK SYMTRZE_DOUBLE                                   
C>                                                                      
C>     @brief Symmetrize and double a matrix                            
C>                                                                      
C>     @author C.Bertoni                                                
C>                                                                      
C>     @param A : Square matrix                                         
C>     @param LDA : leading dimension of A                              
C>     @param N : Size of matrix to symmetrize                          
C>                                                                      
      SUBROUTINE SYMTRZE_DOUBLE(A,LDA,N)                                
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)                                
      DIMENSION A(LDA,N)                                                
C                                                                       
C     ---- SYMMETRIZE A SQUARE MATRIX A (N X N) ----                    
C                                                                       
  ...
  200 CONTINUE                                                          
      ...
      END                                                               
C                                                                       
C*MODULE MTHLIB  *DECK CLEANVEC                                         
C>                                                                      
C>     @brief Clean MOs.                                                
C>                                                                      
C>     @details Round off LCAO.                                         
C>                                                                      
C>     @author Dmitri Fedorov                                           
C>                                                                      
      SUBROUTINE CLEANVEC(V,N,NDIG)                                     
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)                                
      DIMENSION V(N)                                                    
      character*80 str,frmt                                             
C                                                                       
C     clean a vector by rounding off to NDIG figures after the decimal p
c     NDIG must be between 10 and 30.                                   
c     This subroutine uses F format (not E)!                            
C                                                                       
      if(ndig.lt.1.or.ndig.gt.30) call abrt                             
      if(NDIG.GT.9) then                                                
        WRITE(UNIT=frmt,FMT='(5H(F50.,I2,1H))') NDIG                    
      else                                                              
        WRITE(UNIT=frmt,FMT='(5H(F50.,I1,1H))') NDIG                    
      endif                                                             
c     write(6,9000) v                                                   
c     write(6,*) 'fmt=',frmt                                            
      do i=1,n                                                          
        WRITE(UNIT=STR,FMT=frmt) V(I)                                   
        READ(UNIT=STR,FMT=frmt) V(I)                                    
      enddo                                                             
c     write(6,9000) v                                                   
      return                                                            
c9000 format(4F20.16)                                                   
      end                                                               

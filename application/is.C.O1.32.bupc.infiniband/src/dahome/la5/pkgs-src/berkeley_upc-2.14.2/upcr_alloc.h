...
/* Non-collective operation that allocates nblocks * blocksz bytes in the
 ...
 */
#define upcr_local_alloc(nblocks, blocksz) \
       (UPCRI_TRACE_PRINTF(("HEAPOP upc_alloc(%llu)", (unsigned long long)(nblocks*blocksz))), \
        _upcr_local_alloc(nblocks, blocksz UPCRI_PT_PASS))

upcr_shared_ptr_t _upcr_local_alloc(size_t nblocks, size_t blocksz UPCRI_PT_ARG) GASNETT_WARN_UNUSED_RESULT;
...
#define upcr_global_alloc(nblocks, blocksz) \
       (UPCRI_TRACE_PRINTF(("HEAPOP upc_global_alloc(%llu, %llu)", \
        ...
        _upcr_global_alloc(nblocks, blocksz UPCRI_PT_PASS))
...
#define upcr_all_alloc(nblocks, blocksz) \
       (UPCRI_TRACE_PRINTF(("HEAPOP upc_all_alloc(%llu, %llu)", \
          (unsigned long long)(nblocks), (unsigned long long)(blocksz))), \
        _upcr_all_alloc(nblocks, blocksz UPCRI_PT_PASS))
 ...
 * upcr_local_alloc(), upcr_global_alloc() or upcr_all_alloc(). 
 *
 ...
 * call to upcr_local_alloc() from a different thread.
 *

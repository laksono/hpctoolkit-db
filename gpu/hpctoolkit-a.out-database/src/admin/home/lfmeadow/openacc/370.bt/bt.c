...
//#pragma acc data create(forcing,rho_i,u,us,vs,ws,square,qs,rhs) //create(u,forcing,rho_i)
#pragma target data map(alloc: forcing,rho_i,u,us,vs,ws,square,qs,rhs)
{
  initialize();
